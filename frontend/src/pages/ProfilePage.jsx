...
//         duration: 3000,
//       });
//       setIsEditing(false); // Return to read-only mode after submission
//     } catch (error) {
...
//                   value={formData.name}
//                   isReadOnly={!isEditing} // Controlled by isEditing
...
//                   isReadOnly // Email remains read-only
//                   onChange={handleChange}
//                   color="black"
//                   bg="transparent"
//                   _placeholder={{ color: "black" }}
...
//                   isDisabled={!isEditing} // Disable switch when not editing
//                   onChange={() =>
//                     setFormData((prev) => ({
//                       ...prev,
...
//                 mt={4}
//                 color="white"
//                 bg={isEditing ? "green" : "blue"} // Different colors for Edit vs Submit
//                 width="full"
//                 onClick={isEditing ? handleSubmit : () => setIsEditing(true)} // Toggle edit mode or submit
//                 isDisabled={isEditing && !isFormValid()} // Disable submit if form invalid
//                 transition="bg 300ms"
